        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <div class="row g-5 g-xl-8">
                <div class="col-xl-3">
                    ...
                    <a href="{{url('/users')}}" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                ...
                <div class="col-xl-3">
                    <!--begin::Statistics Widget 5-->
                    <a href="{{route('categories.index')}}" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">{{\App\Models\Category::where('parent_id',null)->count()}}</div>
                ...
                <div class="col-xl-3">
                    <!--begin::Statistics Widget 5-->
                    <a href="{{route('subs.index')}}" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{\App\Models\Category::where('parent_id','!=',null)->count()}}</div>
                            <div class="fw-bold text-white">{{ __('lang.products') }}</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3">
                    <!--begin::Statistics Widget 5-->
                    <a href="{{route('orders.index')}}" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{\App\Models\Order::count()}}</div>
                            <div class="fw-bold text-white">{{ __('lang.orders') }}</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-header border-0 py-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label font-weight-bolder text-dark">{{ __('lang.Last 10 Orders') }}</span>
                        </h3>
                            ...
                            <div class="table-responsive">
                                <table
                                    ...
                                    <tr class="text-left text-uppercase">
                                        ...
                                        <th class="min-w-125px">{{__('lang.created_at')}}</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach (\App\Models\Order::take(10)->get() as $order)
                                        <tr>
                                            <td>
                                                <span
                                                    class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$order->id}}</span>

                                            </td>
                                            <td>
                                                <span
                                                    class="text-dark-75 font-weight-bolder d-block font-size-lg"> {{$order->client->name}}</span>
                                            </td>
                                            <td>
                                                <span
                                                    class="text-dark-75 font-weight-bolder d-block font-size-lg"> @if(Session::get('lang')=='en'){{$order->category->getNameEnAttribute()}}  @else {{$order->category->getNameArAttribute()}}  @endif</span>
                                            </td>
                                            <td>
                                                <span
                                                    class="text-dark-75 font-weight-bolder d-block font-size-lg">{{trans('lang.'.$order->type)}}</span>
                                            </td>
                                            <td>
                                                <span
                                                    class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$order->created_at->format('Y-m-d')}}</span>
                                            </td>

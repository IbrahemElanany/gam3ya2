                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">{{\App\Models\City::count()}}</div>
                            <div class="fw-bold text-gray-400">{{ __('lang.cities') }}</div>
                        </div>
                        <!--end::Body-->
                    </a>
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">{{\App\Models\Car::count()}}</div>
                            <div class="fw-bold text-gray-100">{{ __('lang.cars') }}</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3">
                    ...
                    <a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="fw-bold text-white">{{ __('lang.categories') }}</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                                ...
                                <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                                    <thead>
                                        <tr class="text-left text-uppercase">
                                            ...
                                            <th style="min-width: 100px">{{__('lang.car')}}</th>
                                            <th style="min-width: 100px">{{__('lang.USER')}}</th>
                                            <th style="min-width: 100px">{{__('lang.city')}}</th>
                                            <th style="min-width: 130px">{{__('lang.day')}}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
